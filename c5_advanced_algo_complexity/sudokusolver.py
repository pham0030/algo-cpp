...
def varnum(i, j, k):  # return unique variable id (number)
    assert(i in digits and j in digits and k in digits)
    return 100*i + 10*j + k

"""
for example exact_one_of 3 literals could be written in cnf form as
(l1 v l2 v l3)(-l1 v -l2)(-l1 v -l3)(-l2 v -l3)
"""
...
# writing to minisat format solver
